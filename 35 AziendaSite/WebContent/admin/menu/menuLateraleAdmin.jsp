...
<ul>
	<li><a href="${pageContext.request.contextPath}/admin/homePageAdmin.jsp">HomePage</a></li>
	<li><a href="${pageContext.request.contextPath}/admin/registrazioneNuovoCliente.jsp">Nuovo cliente</a></li>
